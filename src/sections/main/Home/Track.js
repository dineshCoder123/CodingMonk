...
const list = [
  {
    ...
    Title: "Frontend",
    Subtitle:
      "Stack: HTML, CSS, JS, React, Redux, MUI Microfrontend & much more",
  },
  {
    img: BackendTrack,
    Title: "Backend",
    Subtitle:
      "Stack: Nodejs, Express, MongoDB, GraphQL, PgSQL, Websocket, Microservices etc.",
  },
  ...
  },
  {
    ...
    Subtitle:
      "Stack: AWS EC2, S3, CI/CD Pipeline & 16 other cloud services + GCP & Azure",
  },
  {
    img: DatabaseExpert,
